...
<head>
    ...
    <body>
        ...
        @endif
            ...
            <form id="loginform" class="form-vertical" action="{{'admin'}}" method="post">{{csrf_field()}}
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><input type="submit" value="Login" name="login" class="btn btn-success" /></span>
                </div>
            </form>
